...
import { BarChart3, Globe, MessageSquare, CheckSquare, Settings, User, Home, TrendingUp, FileText } from "lucide-react"
    ...
    return (
        <Sidebar className="border-r border-blue-200">
            ...
            <SidebarContent className="bg-white">
                ...
                {/* SEO Section */}
                <SidebarGroup>
                    <SidebarGroupLabel className="text-gray-700 font-semibold">SEO</SidebarGroupLabel>
                    <SidebarGroupContent>
                        <SidebarMenu>
                ...
                {/* Tech Stack Section */}
                <SidebarGroup>
                    <SidebarGroupLabel className="text-gray-700 font-semibold">Tech Stack</SidebarGroupLabel>
                    <SidebarGroupContent>
                        <SidebarMenu>
