...
const deleteReport = async (req, res) => {
    ...
    try {
        const report = await SeoReport.findOne({ "phraseResults.jid": jid, clerkUserId });
...
const returnReport = async (req, res) => {
    ...
    try {
        const report = await SeoReport.findOne({ "phraseResults.jid": jid, clerkUserId }).populate("website");
